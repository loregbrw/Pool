...
export class Migration1726952950340 implements MigrationInterface {
    name = 'Migration1726952950340'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Cards" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "name" character varying NOT NULL, "description" character varying(1000) NOT NULL, "dueDate" TIMESTAMP NOT NULL, "status" boolean NOT NULL, "index" integer NOT NULL, "columnId" uuid, "sectionId" uuid, CONSTRAINT "PK_f8d646c98446cc0ef6872e960cc" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "cards_tag_card_tags" ("cardsId" uuid NOT NULL, "cardTagsId" uuid NOT NULL, CONSTRAINT "PK_533a45301912106aa8b6156b06e" PRIMARY KEY ("cardsId", "cardTagsId"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_d5ef0dbc1b3cc0eaebc0e0b768"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_d6c8d6f855013062bff0d35928"`);
