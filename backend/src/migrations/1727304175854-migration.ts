...
export class Migration1727304175854 implements MigrationInterface {
    name = 'Migration1727304175854'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Users" ("id" uniqueidentifier NOT NULL CONSTRAINT "DF_16d4f7d636df336db11d87413e3" DEFAULT NEWSEQUENTIALID(), "createdAt" datetime2 NOT NULL CONSTRAINT "DF_4d6dcaa56443847d1fdb3f589cd" DEFAULT getdate(), "updatedAt" datetime2 NOT NULL CONSTRAINT "DF_61ffd183b0382276c2d733ff018" DEFAULT getdate(), "deletedAt" datetime2, "name" nvarchar(255) NOT NULL, "username" nvarchar(255) NOT NULL, "email" nvarchar(255) NOT NULL, "birthdate" datetime NOT NULL, "password" nvarchar(255) NOT NULL, "image" nvarchar(255) NOT NULL, CONSTRAINT "PK_16d4f7d636df336db11d87413e3" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "cards_tags_card_tags" ("cardsId" uniqueidentifier NOT NULL, "cardTagsId" uniqueidentifier NOT NULL, CONSTRAINT "PK_78632d35eab4d6ae06bb1342f07" PRIMARY KEY ("cardsId", "cardTagsId"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "IDX_355cda844f80f49b022dc5a3a7" ON "cards_tags_card_tags"`);
        await queryRunner.query(`DROP INDEX "IDX_c8102a1f815120b8255a353cc9" ON "cards_tags_card_tags"`);
